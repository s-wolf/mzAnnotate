...
public class SpectrumData {
	...
	private HashMap<Double, List<Fragment>> assignedPeakToStructure = null;
	 ...
	 */
	public SpectrumData(String filename){
	 ...
	 */
	public SpectrumData(String peakString, int mode, double exactMass){
